...
Sqlite for transaction
Sqlite for orderbook
Sqlite for ticker
ContentProvider: 3, for each of transaction, orderbook and ticker, monitoring the change in database, and present the new data
