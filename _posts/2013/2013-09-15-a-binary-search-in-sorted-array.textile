...
* sizeof(array), if array was the integer array passed as a parameter, the sizeof(array) would give the actual size of the pointer, as it interprets array as pointer. (C++ pass integer arrays as pointers). so it will be helpful to pass an integer array's size info together with the array for child-function's convenience. 
